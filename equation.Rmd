...
&\quad \gamma_{2}^{\alpha}(\operatorname{n posted ngsschat chat})\ + \\ 
&\quad \gamma_{3}^{\alpha}(\operatorname{n posted ngsschat non chat})\ + \\ 
&\quad \gamma_{4}^{\alpha}(\operatorname{n posted nonngsschat})\ + \\ 
