...
sjPlot::tab_model(m, show.icc = TRUE, show.ci = TRUE, show.se = TRUE)
...
sjPlot::tab_model(m1, show.icc = TRUE, show.ci = TRUE, show.se = TRUE)
...
sjPlot::tab_model(m2, show.icc = TRUE, show.ci = TRUE, show.se = TRUE)
