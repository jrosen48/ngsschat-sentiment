...
pred_frame <- data.frame(type_of_tweet = rep(c("non-ngsschat", 
                         ...
                         hasJoinedChat = 0,
                         n_posted_chatsessions_s = mean(mod_d$n_posted_chatsessions_s),
                         n_posted_ngsschat_nonchat_s = mean(mod_d$n_posted_ngsschat_nonchat_s),
                         n_posted_non_ngsschat_s = mean(mod_d$n_posted_non_ngsschat_s),
