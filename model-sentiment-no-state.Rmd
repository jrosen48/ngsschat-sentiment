...
sjPlot::tab_model(m3, show.icc = TRUE, show.ci = FALSE, show.se = TRUE, show.std = "std")
...
sjPlot::tab_model(m4, show.icc = TRUE, show.ci = FALSE, show.se = TRUE, show.std = "std")
...
sjPlot::tab_model(m5i, show.icc = TRUE, show.ci = FALSE, show.se = TRUE, show.std = "std")
...
```{r, m8}
m8 <- lmer(senti_scale ~ 1 + year_of_post_centered + type_of_tweet + isTeacher + 
             (1|screen_name), data = d)

sjPlot::tab_model(m8, show.icc = TRUE, show.ci = FALSE, show.se = TRUE, show.std = "std")
...
```{r, m9, eval = TRUE}
m9 <- lmer(senti_scale ~ 1 + year_of_post_centered + type_of_tweet + isTeacher + 
             favorite_count + retweet_count + reply_count +
             (1|screen_name), data = d)

sjPlot::tab_model(m9, show.icc = TRUE, show.ci = FALSE, show.se = TRUE, show.std = "std")
...
```{r, m10, eval = TRUE}
m10 <- lmer(senti_scale ~ 1 + year_of_post_centered + type_of_tweet + isTeacher + 
              favorite_count + retweet_count + reply_count +
              favorite_count_user +
              retweet_count_user +
              (1|screen_name), data = d)

sjPlot::tab_model(m10, show.icc = TRUE, show.ci = FALSE, show.se = TRUE, show.std = "std")
...
```{r, m11, eval = TRUE}
m11 <- lmer(senti_scale ~ 1 + year_of_post_centered + type_of_tweet + isTeacher + 
              favorite_count + retweet_count + reply_count +
              favorite_count_user +
              retweet_count_user +
              statuses_count +
...
sjPlot::tab_model(m11, show.icc = TRUE, show.ci = FALSE, show.se = TRUE, show.std = "std")
...
```{r, m12, eval = TRUE}
m12 <- lmer(senti_scale ~ 1 + year_of_post_centered + type_of_tweet + isTeacher + 
              favorite_count + retweet_count + reply_count +
              favorite_count_user +
              retweet_count_user +
              statuses_count +
...
sjPlot::tab_model(m12, show.icc = TRUE, show.ci = FALSE, show.se = TRUE, show.std = "std")
...
```{r, m13, eval = TRUE}
m13 <- lmer(senti_scale ~ 1 + year_of_post_centered + type_of_tweet + isTeacher + 
              favorite_count + retweet_count + reply_count +
              favorite_count_user +
              retweet_count_user +
              statuses_count +
...
sjPlot::tab_model(m13, show.icc = TRUE, show.ci = FALSE, show.se = TRUE, show.std = "std")
...
sjPlot::tab_model(m14, show.icc = TRUE, show.ci = FALSE, show.se = TRUE, show.std = "std")
